    ...
    for(var [index,store] of stores.entries())
     {
      var latlng = new google.maps.LatLng(
       ...
       var phoneno = store["phoneNumber"];
        bounds.extend(latlng);
       createMarker(latlng,name,address,index+1,statusText, phoneno)
     } 
        map.fitBounds(bounds);
  }
   
  function createMarker(latlng,name,address,index,statusText,phoneno){
    var html = `
